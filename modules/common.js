...
function checkAns() {
	...
	if (stage.box.toString() == Goal[currentLevel].toString()) {
		...
		message("WIN<hr>" + currentCostTime * conf.Fz / 1000 + "s<br>" + currentCostStep + " steps<br>" + costCope + " instructions<br>" + scoreTxt);
